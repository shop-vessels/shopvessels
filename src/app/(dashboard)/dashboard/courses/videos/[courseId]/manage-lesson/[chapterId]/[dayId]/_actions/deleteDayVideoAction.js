...
async function deleteDayVideoAction(courseId, chapterId, dayId, S3Key) {
  try {
    ...
    const removeCourse = await CourseModel.findOneAndUpdate(
      {
        _id: courseId,
...
export default deleteDayVideoAction;
