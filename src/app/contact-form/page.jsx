...
const page = () => {
  return (
    <div className="flex lg:flex-row flex-col w-full justify-between items-center lg:gap-6 gap-12 sm:px-16 px-3 lg:py-28 py-16">
      <div className="text-foreground/75 w-full md:px-0 px-3 ">
        ...
        <p className="text-blue-700 text-lg ">Link of crosponding website</p>
      </div>
