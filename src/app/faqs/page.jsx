...
const page = () => {
  return (
    <div className="  ">
      ...
      <div className="relative aspect-[21/9] overflow-hidden w-full mx-auto">
        <Image
          fill
          src={image}
          alt="image"
      ...
      <div className="px-4">
        <div className="md:px-16 px-8 max-w-7xl mx-auto border-l border-r">
          <p className=" lg:text-3xl text-xl mt-9">
          ...
          <p className="mt-6 lg:text-lg text-sm">
            ...
            Import taxes, duties and related customs fees may be charged
            depending on your country. These charges are determined by the
            customs office of the specific destination. Payment of these charges
            and taxes is the responsibility of the recipient and will not be
            covered by Wakeful Travel. For further details of charges, please
