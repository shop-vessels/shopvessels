...
const Offer = ({ image, detail, currentPrice, previousPrice }) => {
  return (
    <div className="relative  lg:w-[370px] z-0 m-auto border pb-5 rounded-md">
      <Link href="/">
        <Image width={1000} height={1000} className="rounded-md" src={image} alt="image" />
      </Link>
      ...
      <a href="#">
        <h2 className=" text-center mt-3 mb-1 text-lg text-foreground/80 font-semibold">{detail}</h2>
