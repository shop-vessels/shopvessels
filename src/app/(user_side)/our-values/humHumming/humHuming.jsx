...
const humHuming = () => {
  return (
    <div className="lg:p-10 flex justify-center items-center flex-col h-full w-full px-5 z-10">
      <div className="text-center text-foreground/65 max-w-3xl mx-auto bg-white z-20 lg:px-12 lg:py-0 py-6 ">
        <p className="md:text-4xl text-3xl font-semibold">About the Founder</p>

        <p className="md:text-lg mt-4">
          Vessels embodies what I needed during my battle with anxiety and deep
          depression years ago—a brand that understands your process to
          ...
          I&apos;m deeply passionate about sharing the NOW Method with the
          world. <br /> Now, as a Meditation teacher, Breathwork Facilitator and
      ...
      <div className="mt-5 w-full relative aspect-video  rounded-md overflow-hidden lg:max-w-lg">
        <Image
          src={founder}
          alt="image"
